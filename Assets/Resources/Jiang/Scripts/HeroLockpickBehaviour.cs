...
public partial class HeroLockpickBehaviour : MonoBehaviour
{
    public bool isOnGround=false;
    private Animator anim;
    private bool isJumping=false;
    public float SpeedX=6.0f;
    private float SpeedX1,JumpY1;
    public float AssumeFriction=0.15f;
    public float JumpY=15.0f;
    public LayerMask groundLayer,gL2;
    ...
    void FixedUpdate()
    {
        ...
        */
        ...
        if(feetbox.IsTouchingLayers(groundLayer) || feetbox.IsTouchingLayers(gL2))
        {
            isOnGround = true;
        }
        else
